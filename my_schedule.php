                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                                                ...
                                                <?php if (isset($_SESSION['is_pic']) && $_SESSION['is_pic']): ?>
                                                    <?php if ($has_feedback): ?>
                                                        <span class="btn-status btn-status-success">Feedback Terkirim</span>
                                                    <?php else: ?>
                                                        <?php if (!$absen): ?>
                                                            <span class="btn-status">Belum Absen</span>
                                                        <?php elseif ($current_time < $end_time): ?>
                                                            <span class="btn-status">Belum Waktunya</span>
                                                        <?php else: ?>
    ...
    <script>
        ...
        function checkMeetings() {
            ...
            buttons.forEach(btn => {
                ...
                const meetingId = btn.id.split('-')[1];
                const fbBtn = document.getElementById('fb-btn-' + meetingId);
                if (fbBtn && fbBtn.hasAttribute('disabled') && now >= endTime && fbBtn.getAttribute('data-attended') === 'true') {
                    fbBtn.removeAttribute('disabled');
