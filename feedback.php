...
// Check if logged in and is PIC
if (!isset($_SESSION['user_id']) || !($_SESSION['is_pic'] ?? false)) {
...
<body>
    ...
    <script>
        ...
        Swal.fire({
            ...
            text: 'Terima kasih, feedback Anda sangat berarti bagi kami.',
            confirmButtonColor: '#6366f1'
        }).then(() => {
            <?php if ($token): ?>
                window.location.href = 'attendance.php?token=<?= $token ?>';
            <?php else: ?>
